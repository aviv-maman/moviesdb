...
const PopularMovies: FC<PopularMoviesProps> = ({}) => {
  return (
    <div className='animate-in w-full flex'>
      <aside
        id='logo-sidebar'
        className='w-64 p-4 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-950 dark:border-neutral-800'
        aria-label='Sidebar'>
