  ...
  return (
    <div className='w-full flex flex-col items-center'>
      ...
      <div className='animate-in flex flex-col gap-14 opacity-0 max-w-4xl px-3 py-16 lg:py-24 text-foreground'>
        <div className='flex flex-col items-center mb-4 lg:mb-12 text-slate-900 dark:text-white'>
        ...
        <div className='flex flex-col gap-8 text-foreground text-slate-900 dark:text-white'>
